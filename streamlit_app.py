...
<body>
    ...
    <script>
        ...
        const PROFILS = {
            ...
            "Evasion": { s: "SIGNALÉ", c: "#fabb3a", img: "evasion.png", f: "agent.png", n: "Capitaux suspects. Signalement fiscal.", r: "FINANCIER", msg: "⚠️ SIGNALEMENT FISCAL", bc: "#fff3e0" }
        };
        ...
        const QS = [
            ...
            { q: "Profession ?", opt: [["Salarié / Étudiant", "Touriste"], ["Trader / Banquier", "Evasion"], ["Peintre / Artiste", "Artiste"], ["Biologiste / Labo", "Chercheur"]] },
            ...
            { q: "Finances ?", opt: [["Compte salaire", "Touriste"], ["Crypto anonyme", "Hacker"], ["Société offshore", "Evasion"], ["Néant", "Exile"]] },
            ...
            { q: "Origine du voyage ?", opt: [["Europe", "Touriste"], ["Zone de conflit", "Exile"], ["Paradis fiscal", "Evasion"], ["Zone de quarantaine", "Ananas"]] }
        ];
        ...
        function finish() {
            ...
            // Trouver le gagnant (si égalité, le Touriste n'est plus prioritaire par défaut)
            ...
            img.onerror = function() { this.src = PATH + r.f; }; // Charge le fallback si l'image principale manque
            img.src = PATH + r.img;
